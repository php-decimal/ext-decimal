...
$tests = [
    ...
    [Decimal::valueOf("0.1" /* default */), "0.3162277660168379331998893544432719",                 Decimal::DEFAULT_PRECISION],

    [Decimal::valueOf("145", 5),            "12.042",                                               5],
    [Decimal::valueOf("145", 50),           "12.041594578792295480128241030378608052425352405054",  50],
    [Decimal::valueOf("145" /* default */), "12.04159457879229548012824103037861",                  Decimal::DEFAULT_PRECISION],

    [Decimal::valueOf("144", 5),            "12", 5],
    [Decimal::valueOf("144", 50),           "12", 50],
    [Decimal::valueOf("144" /* default */), "12", Decimal::DEFAULT_PRECISION],

    [Decimal::valueOf( "1E-50"),     "1E-25",    Decimal::DEFAULT_PRECISION],
    [Decimal::valueOf("-1E-50"),     "NAN",      Decimal::DEFAULT_PRECISION],
